...
export const envValidationSchema = Joi.object({
  ...
  METRICS_TOKEN: Joi.string().min(32).when("NODE_ENV", { is: "production", then: Joi.required(), otherwise: Joi.optional() }),
  TRUST_PROXY: Joi.boolean().default(false),
  CORS_ORIGINS: Joi.string().default("http://localhost:5173"),
  WEB_APP_URL: Joi.string().uri({ scheme: ["https", "http"] }).when("NODE_ENV", { is: "production", then: Joi.required(), otherwise: Joi.optional() }),
